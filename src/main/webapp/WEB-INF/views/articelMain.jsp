...
<head>
    ...
    <title>DomDie Lagerverwaltung | Articel</title>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Articel</a>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title col-lg-10">All Articel</h4>
                                <a href="/articel/new" class="col-lg-2 btn btn-default"><i class="ti-plus"></i> New
                                    Articel</a>
...
<script type="text/javascript">
    ...
    function loadTable() {
        $.get('/articel/displayAllArticels', function (msg) {
            $("#table-content-load").html(msg);
            $(".more-info").slideUp();
        })
        //$("#table-content-load").load("/articel/displayAllArticels");
    }
        ...
        $('body').on('click', '#delete-action-link', function (e) {
            ...
            $.ajax({
                ...
                if (msg == "GOOD") {
                    $.notify({
                        icon: 'ti-thumb-up',
                        message: "Succesfully deleted Artikel <b> " + name + "</b>"
                    ...
                    $.notify({
                        icon: 'ti-thumb-down',
                        message: "Cannot deleted Artikel <b> " + name + "</b>"
