        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4" style="margin-bottom: 60px;">
                        <div class="card text-center">
                            <div class="content text-center">
                                <form action="/uploadImage/articel/<% out.print(artikel.getId()); %>" method="POST" enctype="multipart/form-data">
                                    <div class="wrapper-image">
                                        <img class="articel-image" src="/img/articelImages/<% out.print(artikel.getBildUrl()); %>"
                                    ...
                                    <input type="submit" value="Upload!" class="btn btn-default editProfilButton">
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <div class="card">
                            <div class="content">
                                <form method="post" action="/articel/edit/<% out.print(artikel.getId()); %>">

                                    <input type="hidden" value="<% out.print(artikel.getId()); %>" name="id">
                                    <input type="hidden" value="<% out.print(artikel.getVersion()); %>" name="version">

                                    <div class="form-group">
                                        <label>Productname</label>
                                        <input type="text" name="productname" minlength="1"
                                               class="form-control border-input"
                                               value="<% out.print(artikel.getName()); %>"
                                        >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hersteller" minlength="1"
                                               class="form-control border-input"
                                               value="<% out.print(artikel.getHersteller()); %>"
                                        >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="instock" min="0" class="form-control border-input"
                                               value="<% out.print(artikel.getInStock()); %>"
                                        >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" min="0" class="form-control border-input"
                                               value="<% out.print(artikel.getPreis()); %>"
                                        >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control border-input" name="kategorie" id="sel1">
                                            <option value="<% out.print(Kategorie.ACCESSOIRE.name()); %>" <%if (artikel.getKategorie().name() == Kategorie.ACCESSOIRE.name()) {%>
                                                    selected <%}%>><% out.print(Kategorie.ACCESSOIRE.name()); %></option>
                                            <option value="<% out.print(Kategorie.CLOTHES.name()); %>"<%if (artikel.getKategorie().name() == Kategorie.CLOTHES.name()) {%>
                                                    selected <%}%>><% out.print(Kategorie.CLOTHES.name()); %></option>
                                            <option value="<% out.print(Kategorie.COMPUTER.name()); %>"<%if (artikel.getKategorie().name() == Kategorie.COMPUTER.name()) {%>
                                                    selected <%}%>><% out.print(Kategorie.COMPUTER.name()); %></option>
                                            <option value="<% out.print(Kategorie.SCHOOL.name()); %>"<%if (artikel.getKategorie().name() == Kategorie.SCHOOL.name()) {%>
                                                    selected <%}%>><% out.print(Kategorie.SCHOOL.name()); %></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" class="form-control border-input"
                                                  ...
                                                  name="description"><% out.print(artikel.getDescription()); %></textarea>
                                    </div>
